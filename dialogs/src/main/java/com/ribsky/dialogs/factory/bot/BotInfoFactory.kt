...
class BotInfoFactory(
    ...
    override fun createDialog(): SimpleDialog = SimpleDialog.create {
        ...
        descriptionSize = 11f
        description =
            "Цей сервіс може містити переклади та відповіді, що працюють на технологіях ML Kit Translation, ML Kit Smart Reply та OpenAI-API. Будь ласка, пам'ятай, що розробники відмовляються від усіх гарантій, пов'язаних з перекладами та відповідями, будь то явних або припущених, включаючи будь-які гарантії точності, надійності та будь-які припущені гарантії товарної придатності, відповідності певній меті та невідповідності правам третіх сторін. Цей сервіс створений для допомоги у вивченні української мови, але він не гарантує 100% правильних відповідей, і його використання залежить від твоєї власної відповідальності."
        icon {
