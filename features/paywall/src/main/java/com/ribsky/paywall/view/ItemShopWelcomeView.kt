...
import com.ribsky.paywall.databinding.ItemPaywallWelcomeBinding

class ItemShopWelcomeView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
) : FrameLayout(context, attrs, defStyleAttr) {

    private val binding = ItemPaywallWelcomeBinding.inflate(LayoutInflater.from(context), this, true)
